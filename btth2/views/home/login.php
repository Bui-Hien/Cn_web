...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/btth02v2/assets/css/style_login.css">
</head>
<body>
<header>
        ...
        <div class="container-fluid">
            <div class="my-logo">
                <a class="navbar-brand" href="#">
                    <img src="http://localhost/btth02v2/assets/images/logo2.png"/>
                </a>
            </div>
...
<main class="container mt-5 mb-5" style="min-height: 100vh">
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= textdomain("/btth02v2/index.php?controller=Auth&action=login") ?>" method="post">
